...
public class Injector {
     ...
     * <p>
     * Конфигурация загружается из файла "config.properties" в директории resources.
     * </p>
     *
     ...
     * <p>
     * Файл должен находиться в директории resources и иметь имя "config.properties".
        ...
        try {
            ...
            if (!fieldType.isInterface()) {
                throw new RuntimeException("Field " + field.getName() +
                        " should be an interface, but it has a type: " + fieldType);
            }
    ...
    private String findImplementation(Class<?> interfaceType) {
        ...
        if (implementation == null || implementation.trim().isEmpty()) {
            throw new RuntimeException("No implementation found for the interface: " +
                    key + ". Check resources/config.properties");
        }
